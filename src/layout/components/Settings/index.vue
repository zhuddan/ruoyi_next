...
const { resetSetting } = useSettingsStoreV2()
const { settings } = storeToRefs(useSettingsStoreV2())
  ...
  <el-drawer v-model="showSettings" :with-header="false" direction="rtl" size="300px">
    ...
    <div class="setting-drawer-block-checbox">
      <div class="setting-drawer-block-checbox-item" @click="handleTheme('theme-dark')">
        ...
        <div v-if="settings.sideTheme === 'theme-dark'" class="setting-drawer-block-checbox-selectIcon" style="display: block;">
          <i aria-label="图标: check" class="anticon anticon-check">
            <svg viewBox="64 64 896 896" data-icon="check" width="1em" height="1em" :fill="settings.theme" aria-hidden="true" focusable="false" class>
      ...
      <div class="setting-drawer-block-checbox-item" @click="handleTheme('theme-light')">
        ...
        <div v-if="settings.sideTheme === 'theme-light'" class="setting-drawer-block-checbox-selectIcon" style="display: block;">
          <i aria-label="图标: check" class="anticon anticon-check">
            <svg viewBox="64 64 896 896" data-icon="check" width="1em" height="1em" :fill="settings.theme" aria-hidden="true" focusable="false" class>
              <path d="M912 190h-69.9c-9.8 0-19.1 4.5-25.1 12.2L404.7 724.5 207 474a32 32 0 0 0-25.1-12.2H112c-6.7 0-10.4 7.7-6.3 12.9l273.9 347c12.8 16.2 37.4 16.2 50.3 0l488.4-618.9c4.1-5.1.4-12.8-6.3-12.8z" />
            </svg>
    ...
    <div class="drawer-item">
      <span>开启 TopNav</span>
      <span class="comp-style">
        <el-switch v-model="settings.topNav" class="drawer-switch" @change="topNavChange" />
      </span>
    </div>
    ...
    <div class="drawer-item">
      <span>动态标题</span>
      <span class="comp-style">
        <el-switch v-model="settings.dynamicTitle" class="drawer-switch" />
      </span>
    </div>
