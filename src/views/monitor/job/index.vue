...
<template>
  <div class="app-container">
      ...
      <el-table-column label="操作" align="center" width="200" class-name="small-padding fixed-width">
        <template #default="scope">
          ...
          <el-tooltip content="删除" placement="top">
            <el-button v-hasPermi="['monitor:job:remove']" link type="primary" icon="Delete" @click="handleDelete(scope.row)" />
          </el-tooltip>
          <el-tooltip content="执行一次" placement="top">
            <el-button v-hasPermi="['monitor:job:changeStatus']" link type="primary" icon="CaretRight" @click="handleRun(scope.row)" />
          </el-tooltip>
          <el-tooltip content="任务详细" placement="top">
            <el-button v-hasPermi="['monitor:job:query']" link type="primary" icon="View" @click="handleView(scope.row)" />
          </el-tooltip>
          <el-tooltip content="调度日志" placement="top">
            <el-button v-hasPermi="['monitor:job:query']" link type="primary" icon="Operation" @click="handleJobLog(scope.row)" />
          </el-tooltip>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog v-model="openCron" title="Cron表达式生成器" append-to-body destroy-on-close>
      <Crontab ref="crontabRef" :expression="expression" @hide="openCron = false" @fill="crontabFill" />
    </el-dialog>
